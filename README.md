...
- Tornar porta e parametros de modelo configuraveis por variavel de ambiente
- Adicionar testes com mock do OpenRouter para evitar dependencia externa
- Expor endpoint de healthcheck (`GET /health`)
- Incluir versionamento de API
